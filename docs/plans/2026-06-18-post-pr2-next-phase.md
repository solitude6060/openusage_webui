...
- This intentionally diverges from the upstream OpenUsage `parseDateMs`, which lacked that heuristic, to keep WebUI plugin date utilities internally consistent for epoch-second expiry values.
